const nosqlInjectionRules = [
  ...
  {
    id: 'NOSQL008',
    pattern: /\bthis\.(password|username|email)\b/i,
    description: 'NoSQL query manipulation using this keyword',
    severity: 'high'
  },
  // Additional operators worth catching
  {
    id: 'NOSQL009',
    pattern: /\{\s*"\$in"\s*:/i,
  ...
  {
    id: 'NOSQL010',
    pattern: /\{\s*"\$exists"\s*:/i,
    description: 'MongoDB $exists operator injection',
    severity: 'medium'
  },
];
