...
export default function LoginPage() {
  ...
  useEffect(() => {
    const savedUser = localStorage.getItem("prismeye_user");
    const savedPass = localStorage.getItem("prismeye_pass");
    if (savedUser) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (rememberMe) {
        localStorage.setItem("prismeye_user", username);
        localStorage.setItem("prismeye_pass", password);
      } else {
        localStorage.removeItem("prismeye_user");
        localStorage.removeItem("prismeye_pass");
      }
    ...
    >
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .forgot-link:hover { color: #A99FF9 !important; }
      `}</style>
      ...
      <div
        style={{
          ...
          height: 600,
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(124,111,247,0.13) 0%, transparent 70%)",
          top: "50%",
          left: "50%",
      ...
      <div
        style={{
          ...
          boxShadow: "0 12px 56px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.04)",
          position: "relative",
        }}
      >
        <p
        ...
        <p style={{ color: "#8B8FA8", fontSize: "0.88rem", marginBottom: 24, textAlign: "center" }}>
        ...
        <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div
            style={{
              ...
              border: `1.5px solid ${userFocus ? "#7C6FF7" : "rgba(124,111,247,0.15)"}`,
              borderRadius: 10,
              padding: "0 14px",
          ...
          <div
            style={{
              ...
              gap: 10,
              background: "rgba(255,255,255,0.05)",
              border: `1.5px solid ${passFocus ? "#7C6FF7" : "rgba(124,111,247,0.15)"}`,
              borderRadius: 10,
              padding: "0 14px",
              transition: "border-color 0.2s",
            }}
          >
            ...
            <div
              ...
              style={{ cursor: "pointer", color: "#8B8FA8", display: "flex", opacity: 0.7 }}
            >
              {showPassword ? (
            ...
            <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer", userSelect: "none" }}>
              <div
                ...
                style={{
                  ...
                  height: 17,
                  borderRadius: 4,
                  border: `2px solid ${rememberMe ? "#7C6FF7" : "rgba(124,111,247,0.35)"}`,
                  background: rememberMe ? "#7C6FF7" : "transparent",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
              ...
              <span style={{ color: "#8B8FA8", fontSize: "0.85rem" }}>Remember me</span>
            </label>
            <span
          ...
          <button
            ...
            style={{
              ...
              width: "100%",
              padding: "13px",
              background: loading ? "#3a3650" : "#7C6FF7",
              ...
              boxShadow: loading ? "none" : "0 4px 18px rgba(124,111,247,0.3)",
